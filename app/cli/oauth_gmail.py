...
Напоминание: в статусе Testing refresh token живёт ~7 дней; после перевода
consent screen в In production (docs/INFRA.md) токен долгоживущий и перевыпуск
нужен только при явном отзыве доступа.
"""
